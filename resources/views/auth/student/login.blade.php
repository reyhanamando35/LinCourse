        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto min-h-screen lg:py-0">
            ...
            <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 ">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" enctype="multipart/form-data" action="{{ route('loginStudent') }}">
                        @csrf
                        <div>
                        ...
                        @include('auth.partials.demo-admin-hint')
                        
                        <button type="submit" class="w-full text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Sign in</button>
                        <p class="text-sm font-light text-gray-500 whitespace-nowrap">
                            Don't have an account yet? <a href="{{ route('registerStudent') }}" class="font-medium text-gray-800 hover:underline ">Sign up</a>
                        </p>
                    </form>
                </div>
            </div>
